...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin','web'], 'prefix' => 'admin'], function() {
    ...
    Route::get('get-categories',['as' => 'admin.get-categories', 'uses' => 'AdminCategoryController@getCategoriesList']);
    Route::resource('categories', 'AdminCategoryController',["as"=>"admin"]);

    //region Articles Routes
    Route::resource('articles', 'AdminArticlesController', ["as"=>"admin"]);
